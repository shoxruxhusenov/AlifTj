...
using AlifTj.Service.Dtos.Commons;
using Newtonsoft.Json;
using System.Xml;

namespace AlifTj.Api.Middleweares
{
    public class ExceptionHandlerMiddleware
    {
        ...
        public async Task HandleErrorAsync(HttpContext httpContext, StatusCodeException exception)
        {
            ...
            string jsonData = JsonConvert.SerializeObject(errorDto, Newtonsoft.Json.Formatting.Indented);
